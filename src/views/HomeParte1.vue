    ...
    <v-row align="center" justify="center">
      <div class="col-md-5">
        <p class="text-justify">
          ...
          condimentum magna, a pharetra nisi imperdiet non. Curabitur sodales,
          ligula quis semper pellentesque, mi tellus vestibulum nisi, id
          tincidunt nisi est fringilla massa. Nunc bibendum mi vel tempor
    ...
    <v-row align="center" justify="center">
      <div class="col-md-5">
        <p class="text-justify">
          ...
          que se la quería vender pedía una millonada por ella. Ante tal
          panorama decidió fabricar su propia versión en China por mucho menos
          dinero. Al poco tiempo nacía Funko. Becker empezó con 35.000 dólares
